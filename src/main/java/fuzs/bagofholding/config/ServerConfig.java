...
public class ServerConfig extends AbstractConfig {
    ...
    List<String> bagBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
    ...
    protected void afterConfigReload() {
        this.bagBlacklist = EntryCollectionBuilder.of(Registry.ITEM).buildSet(this.bagBlacklistRaw);
    }
}
