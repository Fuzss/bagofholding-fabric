package fuzs.bagofholding.client.gui.screens.inventory.tooltip;
...
public class ClientContainerItemTooltip implements ClientTooltipComponent {
   ...
   private boolean hideInventoryContents() {
      return BagOfHolding.CONFIG.client().contentsRequireShift && !IProxy.INSTANCE.hasShiftDown();
   }
   ...
   private float[] getBackgroundColor() {
      if (!BagOfHolding.CONFIG.client().colorfulTooltips || this.backgroundColor == null) {
